...
export const Tab4 = ({ selectedDate }: Tab4Props) => {
  ...
  const clients: Client[] = [
    {
      ...
      overallScore: 92,
      criteria: {
        'Service Quality': { score: 94, details: 'Exceptional service quality with high customer satisfaction' },
        'Innovation': { score: 90, details: 'Strong innovation capabilities and forward-thinking approach' },
        'Scalability': { score: 93, details: 'Excellent scalability and growth potential' },
        'Cost Efficiency': { score: 91, details: 'Competitive pricing with good value proposition' }
      },
      status: 'Approved',
      ...
      <Card className="lg:col-span-2 border-0 shadow-sm bg-white/60 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-lg font-medium">
            {selectedClient ? `${selectedClient.name} - Tab 4 Analysis` : 'Select an entity to view details'}
          </CardTitle>
        </CardHeader>
        <CardContent>
          {selectedClient ? (
            <div className="space-y-6">
              <div className="text-center p-8 bg-white/40 backdrop-blur-lg rounded-2xl shadow-lg border border-white/30">
                ...
                <p className="text-lg text-gray-600 font-medium">Overall Tab 4 Score</p>
              </div>
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p>Select an entity to view detailed analysis</p>
            </div>
          )}
        </CardContent>
      </Card>
