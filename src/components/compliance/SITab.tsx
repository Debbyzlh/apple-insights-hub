...
interface SITabProps {
  selectedDate: Date;
}

export const SITab = ({ selectedDate }: SITabProps) => {
  ...
  const clients: Client[] = [
    {
      id: 1,
      name: 'Systems Integration Pro',
      overallScore: 88,
      criteria: {
        'Implementation Expertise': { score: 91, details: 'Proven track record in complex system implementations' },
        'Project Management': { score: 86, details: 'Strong project management capabilities with some delays' },
        'Integration Capabilities': { score: 89, details: 'Excellent technical integration skills' },
        'Client References': { score: 85, details: 'Good client references with positive feedback' }
      },
      status: 'Under Review',
      ...
      <Card className="lg:col-span-2 border-0 shadow-sm bg-white/60 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-lg font-medium">
            {selectedClient ? `${selectedClient.name} - SI Analysis` : 'Select an SI partner to view details'}
          </CardTitle>
        </CardHeader>
        <CardContent>
          {selectedClient ? (
            <div className="space-y-6">
              <div className="text-center p-8 bg-white/40 backdrop-blur-lg rounded-2xl shadow-lg border border-white/30">
                ...
                <p className="text-lg text-gray-600 font-medium">Overall SI Score</p>
              </div>
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p>Select an SI partner to view detailed analysis</p>
            </div>
          )}
        </CardContent>
      </Card>
